"""
scrapers/b3_bvbg086.py
-----------------------
Boletim diário de operações com renda fixa da B3 — arquivo PR (086).

Fonte: https://www.b3.com.br/pesquisapregao/download?filelist=PR%y%m%d.zip
"""
...
def capturar() -> tuple[list[dict], list[str]]:
    ...
    enriched, header_novo = enriquecer("b3_bvbg086", rows)
...
def main():
    log.info("=== B3 — BVBG 086 (Operações com Renda Fixa) ===")
