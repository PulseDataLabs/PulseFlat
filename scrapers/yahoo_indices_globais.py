# coding: utf-8
"""
Scraper: Yahoo Finance – Índices de Ações Globais
Fonte:   https://finance.yahoo.com
Saída:   data/yahoo_indices_globais.csv
"""
...
TICKERS = [('^BVSP', 'IBOVESPA'), ('^GSPC', 'S_P_500'), ('^IXIC', 'NASDAQ'), ('^DJI', 'DOW_JONES'), ('^VIX', 'VIX'), ('^STOXX50E', 'EURO_STOXX_50'), ('000001.SS', 'SHANGHAI_COMP'), ('^N225', 'NIKKEI_225'), ('^FTSE', 'FTSE_100'), ('^GDAXI', 'DAX'), ('^FCHI', 'CAC_40'), ('^HSI', 'HANG_SENG'), ('^MERV', 'MERVAL'), ('^IPSA', 'IPSA'), ('^MXX', 'IPC_MEXICO'), ('^RUT', 'RUSSELL_2000'), ('^NYA', 'NYSE_COMPOSITE'), ('^AXJO', 'ASX_200'), ('^BSESN', 'SENSEX'), ('^KS11', 'KOSPI'), ('^TWII', 'TAIWAN_WEIGHTED'), ('^JKSE', 'JAKARTA_COMP'), ('^STI', 'STRAITS_TIMES'), ('^KLSE', 'KLCI'), ('^TA35', 'TA_35')]
DYNAMIC_CSV = ""
...
class YahooIndicesGlobaisScraper(BaseScraper):
    name = "yahoo_indices_globais"
    group = "misc"
    enabled = True
    phase = 1
...
if __name__ == "__main__":
    YahooIndicesGlobaisScraper().run()
