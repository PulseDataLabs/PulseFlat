"""
scrapers/b3_cotahist_diario.py
-------------------------------
COTAHIST diário da B3 — histórico diário de cotações (ações, BDRs, ETFs, FIIs, etc.)
em formato de largura fixa.

Fonte: https://bvmf.bmfbovespa.com.br/InstDados/SerHist/COTAHIST_D%d%m%Y.ZIP
"""
...
def capturar() -> tuple[list[dict], list[str]]:
    ...
    enriched, header_novo = enriquecer("b3_cotahist_diario", rows)
