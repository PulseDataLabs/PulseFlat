...
TICKERS = [('EWZ', 'EWZ_IBOV_USD'), ('SMLL.SA', 'SMALL_CAPS_B3'), ('BND', 'VANGUARD_BOND_ETF'), ('HYG', 'HIGH_YIELD_BOND_ETF'), ('LQD', 'INVEST_GRADE_BOND_ETF'), ('SPY', 'SPY_S_P_500_ETF'), ('QQQ', 'QQQ_NASDAQ_ETF'), ('DIA', 'DIA_DOW_JONES_ETF'), ('IWM', 'IWM_RUSSELL_2000_ETF'), ('EEM', 'EEM_EMERGING_MKT_ETF'), ('VGK', 'VGK_EUROPE_ETF'), ('VWO', 'VWO_EMERGING_VANGUARD'), ('XLE', 'XLE_ENERGY_SPDR'), ('XLF', 'XLF_FINANCIAL_SPDR'), ('XLK', 'XLK_TECH_SPDR')]
...
class YahooEtfsScraper(BaseScraper):
    name = "yahoo_etfs"
    group = "misc"
    enabled = True
    phase = 1
