# coding: utf-8
"""
Scraper: Yahoo Finance – Renda Fixa Global
Fonte:   https://finance.yahoo.com
Saída:   data/yahoo_renda_fixa.csv
"""
...
TICKERS = [('^IRX', 'TREASURY_3M'), ('^FVX', 'TREASURY_5Y'), ('^TNX', 'TREASURY_10Y'), ('^TYX', 'TREASURY_30Y')]
DYNAMIC_CSV = ""
...
class YahooRendaFixaScraper(BaseScraper):
    name = "yahoo_renda_fixa"
    group = "misc"
    enabled = True
    phase = 1
