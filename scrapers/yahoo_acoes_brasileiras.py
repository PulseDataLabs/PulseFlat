...
# coding: utf-8
"""
Scraper: Yahoo Finance – Ações Brasileiras
Fonte:   https://finance.yahoo.com
Saída:   data/yahoo_acoes_brasileiras.csv
"""
...
class YahooAcoesBrasileirasScraper(BaseScraper):
    name = "yahoo_acoes_brasileiras"
    group = "misc"
    enabled = True
    phase = 1
        ...
        if custom_csv.exists():
            try:
                ...
                df_filtered = df_custom[
                    df_custom["category"] == "yahoo_acoes_brasileiras"
                ]
...
if __name__ == "__main__":
    YahooAcoesBrasileirasScraper().run()
