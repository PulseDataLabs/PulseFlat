# coding: utf-8
"""
Scraper: Yahoo Finance – Criptoativos
Fonte:   https://finance.yahoo.com
Saída:   data/yahoo_criptoativos.csv
"""
...
TICKERS = [('BTC-USD', 'BITCOIN'), ('ETH-USD', 'ETHEREUM'), ('SOL-USD', 'SOLANA'), ('BNB-USD', 'BNB'), ('XRP-USD', 'RIPPLE'), ('ADA-USD', 'CARDANO'), ('DOGE-USD', 'DOGECOIN'), ('DOT-USD', 'POLKADOT'), ('AVAX-USD', 'AVALANCHE'), ('LINK-USD', 'CHAINLINK'), ('SHIB-USD', 'SHIBA_INU'), ('TRX-USD', 'TRON'), ('LTC-USD', 'LITECOIN'), ('UNI-USD', 'UNISWAP'), ('XLM-USD', 'STELLAR'), ('ATOM-USD', 'COSMOS'), ('ETC-USD', 'ETHEREUM_CLASSIC'), ('FIL-USD', 'FILECOIN'), ('HBAR-USD', 'HEDERA'), ('NEAR-USD', 'NEAR_PROTOCOL'), ('ICP-USD', 'INTERNET_COMPUTER'), ('APT-USD', 'APTOS'), ('OP-USD', 'OPTIMISM'), ('GRT-USD', 'THE_GRAPH'), ('IMX-USD', 'IMMUTABLE')]
DYNAMIC_CSV = ""
...
class YahooCriptoativosScraper(BaseScraper):
    name = "yahoo_criptoativos"
    group = "misc"
    enabled = True
    phase = 1
