...
from utils.base import agora_brt, nova_session, salvar_csv
from utils.parsers import csv_rows, decode_bytes, enriquecer
...
def run():
    ...
    column_mapping = {"data": "data_referencia", "codigo_do_ativo": "codigo_ativo"}
        ...
        if resp and resp.content:
            try:
                ...
                if rows:
                    ...
                    enriched, _ = enriquecer(
                        dataset_id, mapped_rows, data_captura_override=data_captura
                    )
